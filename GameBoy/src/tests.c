...
/*
PC=0206 OP=20 JR NZ, e8
FLAGS: N = 0, Z = 0, C = 0, HC = 0
AF=4100 BC=C30B DE=C5FF HL=45FF SP=DFFF

PC=0207 OP=2A LD A, [HL+]
FLAGS: N = 0, Z = 0, C = 0, HC = 0
AF=0000 BC=C30B DE=C5FF HL=4600 SP=DFFF

PC=0208 OP=12 LD [DE], A
FLAGS: N = 0, Z = 0, C = 0, HC = 0
AF=0000 BC=C30B DE=C5FF HL=4600 SP=DFFF

PC=0209 OP=1C INC E
FLAGS: N = 0, Z = 1, C = 0, HC = 1
AF=00A0 BC=C30B DE=C500 HL=4600 SP=DFFF

PC=020B OP=20 JR NZ, e8
FLAGS: N = 0, Z = 1, C = 0, HC = 1
AF=00A0 BC=C30B DE=C500 HL=4600 SP=DFFF

PC=020C OP=14 INC D
FLAGS: N = 0, Z = 0, C = 0, HC = 0
AF=0000 BC=C30B DE=C600 HL=4600 SP=DFFF

PC=020D OP=0D DEC C
FLAGS: N = 1, Z = 0, C = 0, HC = 0
AF=0040 BC=C30A DE=C600 HL=4600 SP=DFFF
